...
<p align="left">👋 Sobre mim<br>Sou um desenvolvedor fullstack curioso e criativo, sempre explorando os limites entre desenvolvimento e segurança.<br>Gosto de automatizar processos, construir ferramentas úteis e estudar sistemas a fundo — especialmente onde código encontra rede e segurança.<br><br>💻 Tecnologias e Skills<br>Linguagens:<br>TypeScript, JavaScript, PHP, Python, Shell Script<br><br>Frontend:<br>React, Vue, Next.js, Nuxt.js<br><br>Backend:<br>Fastify, Nest.js, Redis,Knext,PHP,Laravel<br><br>Ferramentas:<br>🐳 Docker, 🔧 Git, 🌐 WebSocket, 🗃️ Redis, 🔍 Nmap, 📡 Wireshark, 💣 Metasploit, 🎯 SET (Social Engineering Toolkit), 🕷️ Burp Suite, ⚔️ Starkiller<br><br>Testes:<br>✅ Testes automatizados, 🛡️ Validação de rotas, 🔄 Mocking, 🔧 Testes de integração<br><br>Cyber Sec:<br>🎯 Pentest, 🔴 Red Team,  🛡️ Segurança ofensiva, 🧩 Engenharia reversa, 🤖 Automação de exploits</p>
